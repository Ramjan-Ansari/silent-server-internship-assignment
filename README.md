...
## ✅ All tasks in this assignment have been completed.  
> The terminal outputs for each test route (Login, Verify OTP, Get Token, Protected Route) are included in the `output.txt` file.


## Here is Assigment Task Description: 

...
app.post("/auth/verify-otp", (req, res) => {
  try {
    ...
    //for debug
    // console.log("receved otp", otp, typeof(otp));
    // console.log("stored otp", otpStore[loginSessionId], typeof(otpStore[loginSessionId]));
...
app.post("/auth/token", async (req, res) => {
  try {
    ...
    const hmacToken = await generateToken(session.email);
